...
public class Busqueda extends javax.swing.JFrame {
    ...
    public Busqueda(Clientes clientes, JTextField txtID) {
        initComponents();
    ...
    private void actualizar(String condicion){
        ...
        try{
            ...
            if(condicion == null || condicion.isEmpty()){
                sql="SELECT * FROM clientes WHERE fecha_eliminado IS NULL";    
                consulta =  cn.prepareStatement(sql); 
                rs = consulta.executeQuery();
            }else{
                sql="SELECT * FROM clientes WHERE fecha_eliminado IS NULL AND nombre LIKE ?";   
                consulta =  cn.prepareStatement(sql); 
